...
public:
	...
	{
		printf("     1열    2열    3열    4열\n");
		printf("1행 %5.2f  %5.2f  %5.2f  %5.2f\n", m_r00, m_r01, m_r02, m_r03);
		printf("2행 %5.2f  %5.2f  %5.2f  %5.2f\n", m_r10, m_r11, m_r12, m_r13);
		printf("3행 %5.2f  %5.2f  %5.2f  %5.2f\n", m_r20, m_r21, m_r22, m_r23);
		printf("4행 %5.2f  %5.2f  %5.2f  %5.2f\n", m_r30, m_r31, m_r32, m_r33);
...
int main()
{
	printf("4행 4열의 덧셈과 뺄셈을 확인해봅니다.\n\n");
	printf("matFirst\n");
	printf("-------------------------------\n");
	Matrix4X4 matFirst(5.0f, 2.0f, 4.0f, 7.0f,
		               9.0f, 3.0f, 7.0f, 3.0f,
                       6.0f, 4.0f, 8.0f, 7.0f,
                       1.0f, 2.0f, 4.0f, 9.0f);
	...
	printf("matSecond\n");
	printf("-------------------------------\n");
	Matrix4X4 matSecond(-5.0f,  3.0f,  8.0f, -7.0f,
                         1.0f,  6.0f, -7.0f,  9.0f,
                         3.0f, -4.0f,  6.0f,  7.0f,
                         5.0f,  1.0f,  2.0f, -9.0f);
	...
	/////////////////////////////////////////////////////////////////
	printf("matFirst에 matSecond를 더해서 값을 증가시킵니다.\n");
	printf("-------------------------------\n");
	matFirst.Add(matSecond);
	matFirst.ShowElement();
	printf("-------------------------------\n\n");
	/////////////////////////////////////////////////////////////////
	printf("matFirst에 matSecond를 빼서 값을 감소시킵니다.\n");
	printf("-------------------------------\n");
	matFirst = matTemp;
	matFirst.Subtract(matSecond);
	matFirst.ShowElement();
	printf("-------------------------------\n\n");
	/////////////////////////////////////////////////////////////////
	printf("matTemp에 matFirst와 matSecond를 더한 결과를 대입합니다.\n");
	printf("-------------------------------\n");
	matFirst = matTemp;
	matTemp.Zero();
	...
	printf("-------------------------------\n\n");
	/////////////////////////////////////////////////////////////////
	printf("matTemp에 matFirst와 matSecond를 뺀 결과를 대입합니다.\n");
	printf("-------------------------------\n");
	matTemp.Zero();
	matTemp = matFirst - matSecond;
	matTemp.ShowElement();
